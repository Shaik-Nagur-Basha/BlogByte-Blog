    ...
    <>
      <Navbar className="border-b-2 sticky top-0 right-0 left-0 z-50 shadow-sm shadow-black dark:shadow-white">
        ...
        <Navbar.Collapse style={{ letterSpacing: "0.5px" }}>
          ...
          <div className={!currentUser ? "sm:hidden" : "hidden"}>
            <Navbar.Link
      ...
      {!currentUser && (
        <Button
          ...
          className="hover:bg-gradient-to-tl text-black dark:text-white shadow-sm shadow-black dark:shadow-gray-500 fixed right-2 z-50 top-20"
          style={{ letterSpacing: "1px" }}
          href="/sign-up"
        >
          CREATE ACCOUNT
